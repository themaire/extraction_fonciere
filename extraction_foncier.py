...
def progCommand(directory, infos, where):
    '''
    Fabrique la commande a executer pour appeler pgsql2shp et extraire les données de la base.

    @param directory : le dossier de destination
    @param infos : les infos de l'extraction
    @param where : le where de la requete
